...
export function SuperPushButton() {
    ...
    if (!supported) {
        return (_jsx("span", { className: "text-xs text-slate-400", title: "\u0411\u0440\u0430\u0443\u0437\u0435\u0440 \u043D\u0435 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u0438\u0432\u0430\u0435\u0442 Web Push", children: "\uD83D\uDD15 push \u043D\u0435 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u0438\u0432\u0430\u0435\u0442\u0441\u044F" }));
    }
    ...
    return (_jsxs("button", { type: "button", onClick: subscribed ? unsubscribe : subscribe, disabled: busy || subscribed === null, className: `inline-flex items-center gap-1 rounded-lg border px-3 py-1.5 text-xs disabled:opacity-50 ${subscribed
            ? "border-emerald-300 bg-emerald-50 text-emerald-700 hover:bg-emerald-100"
            : "border-slate-300 text-slate-700 hover:bg-slate-100"}`, title: subscribed ? "Push-уведомления включены" : "Включить push-уведомления", children: [subscribed ? _jsx(Bell, { size: 14 }) : _jsx(BellOff, { size: 14 }), busy ? "…" : subscribed ? "Уведомл. вкл." : "Уведомления"] }));
}
